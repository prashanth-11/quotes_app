...
const Flexbox = () => {
  return (
   ...
   <h1 className="text-align:center;">Material cards FlexBox</h1>
   ...
   <div class="o-card_container">
      <div class="o-card" id="Nikola_Tesla">
         <div class="o-card_header">
            ...
            <div class="o-card_logo" className="background:url(https://s3.eu-west-2.amazonaws.com/pirolab/images/tesla.jpg) center no-repeat;"></div>
         </div>
      ...
      <div class="o-card" id="Ernest_Hemingway">
         <div class="o-card_header">
            ...
            <div class="o-card_logo" className="background:url(https://s3.eu-west-2.amazonaws.com/pirolab/images/hemingway.jpg) center no-repeat;"></div>
         </div>
         <div class="o-card_body">
            <h2 class="o-card_title">Ernest Hemingway</h2>
            <h3 class="o-card_subTitle">The Brave</h3>
            <p class="o-card_paragraph">Ernest Miller Hemingway (July 21, 1899 – July 2, 1961) was an American novelist, short story writer, and journalist. His economical and understated className had a strong influence on 20th-century fiction, while his life of adventure and his public image influenced later generations. Hemingway produced most of his work between the mid-1920s and the mid-1950s, and won the Nobel Prize in Literature in 1954. He published seven novels, six short story collections, and two non-fiction works....</p>
         </div>
         <div class="o-card_footer">
      ...
      <div class="o-card" id="J_R_R_Tolkien">
         <div class="o-card_header">
            ...
            <div class="o-card_logo" className="background:url(https://s3.eu-west-2.amazonaws.com/pirolab/images/tolkien.jpg) center no-repeat;"></div>
         </div>
         <div class="o-card_body">
      ...
      <div class="o-card" id="Malcolm_X">
         <div class="o-card_header">
            ...
            <div class="o-card_logo" className="background:url(https://s3.eu-west-2.amazonaws.com/pirolab/images/malcom-x.jpg) center no-repeat;"></div>
         </div>
         <div class="o-card_body">
      ...
      <div class="o-card" id="George_Orwell">
         <div class="o-card_header">
            ...
            <div class="o-card_logo" className="background:url(https://s3.eu-west-2.amazonaws.com/pirolab/images/g-orwell.jpg) center no-repeat;"></div>
         </div>
         <div class="o-card_body">
      ...
      <div class="o-card" id="Albert_Einstein">
         <div class="o-card_header">
            ...
            <div class="o-card_logo" className="background:url(https://s3.eu-west-2.amazonaws.com/pirolab/images/einstein.jpg) center no-repeat;"></div>
         </div>
         <div class="o-card_body">
